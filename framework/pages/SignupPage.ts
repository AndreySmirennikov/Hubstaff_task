...
import { Button, Input, Checkbox, Link, Popup, Text } from '../wrapper';
...
export class SignupPage extends BasePage {
    ...
    constructor(page: Page) {
        ...
        this.createAccountButton = new Button(this.page, '[data-testid="create_my_account"]', 'Create My Account Button');
        this.pageTitle = new Text(this.page, 'div[class*=heading]', 'Page Title');
        this.errorDialog = new Button(this.page, 'dialog:has-text("This domain is prevented")', 'Error Dialog');
        this.okButton = new Button(this.page, 'button:has-text("OK")', 'OK Button');
    }

    async fillSignupForm(userData: SignupData) {
