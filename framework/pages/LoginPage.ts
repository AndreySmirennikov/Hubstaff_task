...
export class LoginPage extends BasePage {
    ...
    constructor(page: Page) {
        super(page);
        this.workEmailInput = Input.fromLocator(this.page.getByRole('textbox', { name: 'Work email *' }), 'Work Email Input');
        this.passwordInput = Input.fromLocator(this.page.getByRole('textbox', { name: 'Password *' }), 'Password Input');
        this.signInButton = Button.fromLocator(this.page.getByRole('button', { name: 'Sign in' }), 'Sign in Button');
        this.pageHeading = Text.fromLocator(this.page.getByRole('heading', { name: 'Sign in to Hubstaff' }), 'Page Heading');
    }
